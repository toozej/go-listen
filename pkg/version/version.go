// Package version provides build and version information for the go-listen application.
//
...
//
//	go build -ldflags "-X github.com/toozej/go-listen/pkg/version.Version=v1.0.0 \
//	  -X github.com/toozej/go-listen/pkg/version.Commit=abc123 \
//	  -X github.com/toozej/go-listen/pkg/version.Branch=main"
//
// Example usage:
//
//	import "github.com/toozej/go-listen/pkg/version"
//
...
// Build-time injection example:
//
//	go build -ldflags "-X github.com/toozej/go-listen/pkg/version.Version=v1.2.3"
var (
